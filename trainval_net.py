...
if __name__ == '__main__':
    ...
    if args.optimizer == "adam":
        ...
        optimizer = torch.optim.RMSprop(params, momentum=cfg.TRAIN.MOMENTUM, weight_decay=cfg.TRAIN.WEIGHT_DECAY)
    ...
    # from model.utils.net_utils import SizeEstimator
    # se = SizeEstimator(model, input_size=(16, 1, 256, 256))
    # print('Model size: ', se.estimate_size())
    ...
    # with open('rpn_loss_nan_augs.pkl', 'wb') as fid:
    #     pickle.dump(bad_augs, fid, pickle.HIGHEST_PROTOCOL)